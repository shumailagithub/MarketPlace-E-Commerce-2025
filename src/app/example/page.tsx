...
const page = async () => {
  ...
  return (
    <div className="container px-10 py-10">
      <h2 className="text-3xl font-bold text-center py-10 leading-10">Our Products</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-4 justify-items-center">
        {res.map((ourProduct: Product, i: number) => (
          <div
            key={i}
            className="bg-white rounded-lg shadow-md border border-gray-300 justify-center items-center w-[280px] h-[400px]"
          >
            <div className="relative w-full h-[270px]">
              <Image
                src={ourProduct.productImage}
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-500 mt-2 line-clamp-2">{ourProduct.description}</p>
              <div className="flex items-center justify-between mt-2">
                <span className="text-lg font-semibold text-text2">${ourProduct.price}</span>
                {ourProduct.price && (
                  <span className="text-sm text-gray-500 line-through">${ourProduct.price}</span>
                )}
              </div>
            </div>
          </div>
