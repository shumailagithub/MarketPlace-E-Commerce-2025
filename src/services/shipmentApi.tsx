...
export async function postReq(item: Data){
    ...
    const {to_name, to_phone, to_address, to_city,  from_address, from_city, from_name, from_company, from_phone, weight_value, height, width, length} = item
